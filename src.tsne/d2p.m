function [P, beta] = d2p(D, u, tol, verbosity)
...
% Maastricht University
    ...
    for i=1:n
        ...
        if ~rem(i, 500)
            dispv(['Computed P-values ' num2str(i) ' of ' num2str(n) ' datapoints...'], verbosity);
        end
    ...
    dispv(['Mean value of sigma: ' num2str(mean(sqrt(1 ./ beta)))], verbosity);
    dispv(['Minimum value of sigma: ' num2str(min(sqrt(1 ./ beta)))], verbosity);
    dispv(['Maximum value of sigma: ' num2str(max(sqrt(1 ./ beta)))], verbosity);
end
